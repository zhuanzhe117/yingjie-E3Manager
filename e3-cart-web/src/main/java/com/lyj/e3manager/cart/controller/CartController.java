package com.lyj.e3manager.cart.controller;
...
public class CartController {
    ...
    public String addCart(@PathVariable int itemId, @RequestParam(defaultValue = "1") Integer num, HttpServletRequest request, HttpServletResponse response){
        //添加购物车前先判断用户是否登录
